package com.example.triagung.uas_sms;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPhoneNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent("com.example.triagung.uas_sms.VIEWCONTACT"));
            }
        });
    ...
    private void sendSMS(String txtphoneNo, String txtMessage) {
        ...
        sms.sendTextMessage(txtphoneNo, null, txtMessage, sentPI, deliveredPI);
    }
    }
